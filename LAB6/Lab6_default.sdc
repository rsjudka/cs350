...
We stop reading the file if we hit a sentinel (value too big for memory)
 ...
 5178	00	LDM R1, 78
-5278	01	LDM R2, -78	sign is important
 6189	02	ADM R1, 89
-6289	03	ADM R2, -89	sign is important
-2145	04	ST R1, 45	should ignore sign
 1345	05	LD R3, 45
 3345	06	ADD R3, 45
 4367	07	NEG R3
 7810	08	BR 10 		skip over infinite loop
 7009	09	BR 09 		infinite loop; should be skipped
 8112	10	BR+ R1,12 	skip over infinite loop
 7011	11	BR 11		infinite loop
-8214	12	BR- R2,14	skip over infinite loop
 7013	13	BR 13		infinite loop
 9011	14	GETC
-9199	15	PUTC		should ignore sign
 9221	16	PUTS 21
 9345	17	DMP
-9455	18	MEM			should ignore sign
 9500	19	NOP
 0000	20	HALT
